...
msg.setAddress("/led")
msg.append(1)
client.sendto(msg, ('10.3.1.228', 8000)) # note that the second arg is a tupple and not two arguments



# ## better practice ##
# client = OSC.OSCClient()
# client.connect( ('10.3.1.224', 9000) ) # note that the argument is a tupple and not two arguments
...
# # single message
# msg = OSC.OSCMessage()
# msg.setAddress("/led") # set OSC address
# msg.append(44) # int
